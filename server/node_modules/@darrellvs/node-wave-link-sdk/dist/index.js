...
var BaseWaveLinkController = class _BaseWaveLinkController extends TypedEventEmitter {
  ...
  static getWsInfoPath() {
    if (process.platform === "win32") {
      const localAppData = process.env.LOCALAPPDATA ?? (process.env.APPDATA ? (0, import_path.join)(process.env.APPDATA, "../Local") : null);
      if (localAppData) {
  ...
  tryConnect() {
    ...
    const ws = new import_ws.WebSocket(url, { headers: { Origin: "streamdeck://" } });
    this.ws = ws;
    ws.onopen = () => {
